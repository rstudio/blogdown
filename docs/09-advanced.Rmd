...
If your website source files are under version control\index{Version Control}, we recommend you to add at least these two folder names to your `.gitignore` file:
