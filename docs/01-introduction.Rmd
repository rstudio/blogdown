...
To upgrade or reinstall Hugo, you may pass `force = TRUE` to `install_hugo()`. You can check the installed Hugo version via `blogdown::hugo_version()`, and find the latest version of Hugo at <https://github.com/spf13/hugo/releases>.
