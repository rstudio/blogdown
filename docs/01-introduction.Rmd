...
Next, go online to\index{Netlify} Drop https://app.netlify.com/drop. You can drag and drop the `public/` folder from your file viewer to the indicated area on the Netlify web page, where it says "Drag a folder with a static site here." 
...
Netlify has a free plan with plenty of useful features. To sign up:
...
1. If you used Netlify Drop, with an account, you can (and should) change your random subdomain to a more meaningful one. You may read the docs for changing a site's default Netlify subdomain here: https://docs.netlify.com/domains-https/custom-domains/#assign-a-domain-to-a-site
