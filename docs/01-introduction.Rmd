...
We assume you have already installed R (https://www.r-project.org), the RStudio IDE (https://www.rstudio.com), and pandoc (http://pandoc.org/). Next we need to install the **blogdown** package in R. Currently it is only available on GitHub, and you can install it using the **devtools** package:
