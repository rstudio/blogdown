...
```html
<text style="color:red">Marco!</text>
Polo!
```
Would produce text that looks like this:
<text style="color:red">Marco!</text>
Polo!
...
<div id="book">
  <p id="name">My name is Bananas Gorilla.</p>
  <p id="aboutme">I wear lots of watches on both wrists.</p>
  <p id="vehicle">I drive a bananamobile.</p>
</div>
</html>
```

In this example, the last line of text, <em>"I drive a bananamobile."</em>, is italicized. 
