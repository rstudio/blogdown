...
In a nutshell, JavaScript is a langauge that is typically used to manipulate elements on a web page. An effective way to learn it is through the JavaScript console in the Developer Tools of your web browser (see Figure \@ref(fig:chrome-devtools)), because you can interactively type code inthe console and execute it, which feels similar to executing R code in the R console (e.g., in RStudio). You may open any web page in your web browser (e.g., <https://yihui.name>), then open the JavaScript console, and try the code below on any web page:
...
For R users, you have to be extremely cautious that JavaScript objects are often mutable, meaning that it could be modified anywhere. Below is a quick example:
...
Note that Netlify has provided the optimization features on the server side for free at the moment, so you may just want ot enable them there instead of doing all the hard work by yourself.
