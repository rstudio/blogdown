...
GitLab's CI/CD service uses the instructions stored in the file `.gitlab-ci.yml` in the repository. Here is a sample configuration file `.gitlab-ci.yml` from the example repository https://gitlab.com/rgaiacs/blogdown-gitlab:
