...
**and any generated content, such as HTML files, will be copied to the web server**
instead of stored in the Git repository.

This approach has similar issues as we mentioned in Section \@ref(travis-github),
such as,
somewhat unpredictable the output
and
timeouts on GitLab server.
...
before_script:
  - apt-get update
  - apt-get -y install curl libcurl4-openssl-dev openssl libssl-dev git pandoc r-base-core
