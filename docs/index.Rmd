...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html4'), fig.link='https://www.crcpress.com/p/book/9780815363729', out.width='50%'}
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html4'), fig.link='https://github.com/rstudio/blogdown'}
