...
::: {.infobox .caution}
**A note from the authors**: This book contains some information and instructions that are now out of date because of changes to Hugo and the blogdown package. Thanks for your patience while we work to update the book, and please stay tuned for the revised version! <br>
Thank you &mdash; Yihui, Amber, & Alison
:::
```
